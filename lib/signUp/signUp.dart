...
import 'package:annurbusana_application_project/globalTextfield.dart';
import 'package:annurbusana_application_project/pagerouteanimation.dart';
import 'package:annurbusana_application_project/userInfo/userForm.dart';
  ...
  Future signup() async {
    try {
      ...
      if (userCredential.user.uid.isNotEmpty) {
        ...
        Navigator.push(context, createdroute(Userform()));
